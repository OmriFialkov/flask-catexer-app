    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                cd flask-catexer-app/
                TAG=1.0.${BUILD_NUMBER} docker-compose build --no-cache
                """
    ...
    steps {
        script {
            withCredentials([usernamePassword(credentialsId: 'docker-creds', usernameVariable: 'DOCKER_USER', passwordVariable: 'DOCKER_PASS')]) {
                ...
                docker tag crazyguy888/flask-compose-catproject:1.0.${BUILD_NUMBER} crazyguy888/flask-compose-catproject:latest
                docker push crazyguy888/flask-compose-catproject:1.0.${BUILD_NUMBER}
